...
export function TradePlaybook({ trade }: TradePlaybookProps) {
  const [selectedPlaybook, setSelectedPlaybook] = useState(trade.playbook || 'ICT 2022 Model')
      ...
      <div className="max-w-md">
        <div className="mb-4">
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
            Add a Playbook to your trade and track what works
          </h3>
        </div>
