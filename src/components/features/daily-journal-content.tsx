      ...
      <div className="flex gap-8 max-w-none">
        ...
        <div className="flex-1 space-y-4 min-w-0">
          {dataToUse.length === 0 ? (
            ...
            return (
            <div key={card.id} className="relative w-full rounded-[32px] bg-[#fafcff] dark:bg-[#171717] shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.3)] overflow-visible">
              {/* Card Header */}
              ...
              <div className="mb-6 rounded-[24px] bg-white dark:bg-[#0f0f0f] shadow-sm">
