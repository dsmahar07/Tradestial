    ...
    <div className="fixed inset-0 overflow-y-auto overflow-x-visible">
      <div className="flex min-h-full items-center justify-center p-4 text-center">
        <DialogPanel
          ...
          ref={ref}
          className={cn(
            'relative w-full max-w-md transform-gpu will-change-transform overflow-visible rounded-2xl bg-white dark:bg-[#0f0f0f] p-6 text-left align-middle shadow-xl data-[enter]:scale-100 data-[enter]:opacity-100 data-[leave]:opacity-0 data-[leave]:scale-95 data-[enter]:duration-250 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in',
            className
          )}
          {...props}
        >
