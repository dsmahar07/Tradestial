...
export function TradingStreakHeatmap() {
  ...
  if (!trades.length) {
    return (
      ...
      >
        <div className="bg-white dark:bg-[#0f0f0f] rounded-xl pt-4 px-6 pb-6 text-gray-900 dark:text-white relative focus:outline-none flex flex-col" style={{ height: '480px' }}>
