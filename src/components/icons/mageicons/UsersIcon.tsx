...
export const UsersIcon: React.FC<UsersIconProps> = ({ className, size }) => {
  return (
    <MageIcon className={className} size={size} fill="none">
      ...
      <path d="M15.2774 8.80157L10.6983 13.3806" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </MageIcon>
  );
};