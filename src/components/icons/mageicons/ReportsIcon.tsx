...
export const ReportsIcon: React.FC<ReportsIconProps> = ({ className, size }) => {
  return (
    <svg 
      className={className} 
      width={size || 24} 
    ...
    >
      <path d="M14.1863 2.7529V6.34867C14.1863 6.8364 14.3807 7.30415 14.7269 7.64902C15.0731 7.9939 15.5426 8.18765 16.0322 8.18765H20.1572" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <path d="M7.64709 7.64706H10.9118" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M7.64709 12H16.353" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M7.64709 16.3529H16.353" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
};